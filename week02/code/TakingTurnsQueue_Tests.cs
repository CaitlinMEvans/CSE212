...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue() adds to front instead of back - violates FIFO. 
    // Also, people with exactly 1 turn aren't getting re-added when they should be.
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, George, Sue, Tim, George, Tim, George
     // Defect(s) Found: Same issues as above - wrong enqueue order and turn counting logic.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Negative turn values should also represent infinite turns but aren't handled correctly.
