...
public static class Search
{
    ...
    /// 
    /// BIG O ANALYSIS: O(n) - Linear Search
    /// In worst case (target not found), must check every element in array
    /// </summary>
    ...
    /// the work done in the function is returned.
    /// 
    /// BIG O ANALYSIS: O(log n) - Binary Search
    /// Divides search space in half with each recursive call
    /// </summary>
    /// <param name="data">The array of numbers</param>
    /// <param name="target">The number we're looking for</param>
